...
declare const SHORTY: {
	...
	normalizeOptions: <T_8 extends {
		[key: string]: any;
	}>(element: HTMLElement, defaultOps: T_8, inputOps: Partial<T_8>, ns?: string | undefined) => T_8;
	...
	ArrayFrom: <T_9>(arr: ArrayLike<T_9> | Iterable<T_9>) => T_9[];
	...
	ObjectHasOwn: <T_10 extends object, K extends PropertyKey>(obj: T_10, prop: K) => obj is T_10 & Record<K, unknown>;
	ObjectAssign: {
